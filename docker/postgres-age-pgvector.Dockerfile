...
#
# This mirrors tests/MyGraphRagV5.Tests/age-pgvector.Dockerfile (used by the Testcontainers
# integration tests) - kept in sync intentionally, see docker/README.md.
